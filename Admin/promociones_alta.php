...
<form name="Forma01" id="Forma01" enctype="multipart/form-data" >
    <header><h1>ALTA PROMOCIONES</h1></header>
    <hr>
    <?php include 'menu.php' ?>
    <a href="promociones_lista.php" style="text-decoration: none; color: white; background-color: #333; border: none; padding: 10px 20px; margin-bottom: 20px; display: inline-block; border-radius: 5px;">Regresar al listado</a> <br>
    <input type="text" name="nombre" id="nombre" placeholder="Nombre promocion"/> <br>
    <p>Imagen promocion:</p>
